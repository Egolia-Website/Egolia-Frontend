        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-12 w-full py-24">
          <div className="max-w-3xl">
            ...
            >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-white/[0.08] backdrop-blur-sm border border-white/[0.18] text-white font-bold text-sm rounded-full tracking-wide hover:bg-white/[0.14] hover:border-white/30 transition-all duration-300"
              >
                Get In Touch
              </Link>
            </motion.div>
