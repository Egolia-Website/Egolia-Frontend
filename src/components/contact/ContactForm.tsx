      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 items-start">
          ...
          >
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 flex items-center justify-center text-white/70 mt-0.5">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
            ...
            {/* Decorative circles */}
            <div className="hidden md:block absolute -bottom-10 -right-10 w-40 h-40 border border-white/5 rounded-full" />
            <div className="hidden md:block absolute -bottom-4 -right-4 w-24 h-24 border border-white/5 rounded-full" />
          </motion.div>
