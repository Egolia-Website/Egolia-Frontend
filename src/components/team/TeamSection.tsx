        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {members.map((member, i) => (
              <motion.div
                key={member.name + i}
                className="bg-white p-6 hover:shadow-[0_8px_30px_rgba(15,28,63,0.06)] transition-all duration-500 cursor-pointer group"
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden bg-gray-light mb-5">
                  <Image
                    src={member.image}
                    alt={member.name}
                    fill
                ...
                <p className="text-navy/75 text-base leading-[1.6] mb-4">{member.bio}</p>
