  ...
  return (
    <section className="relative min-h-[calc(100vh-84px)] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-6 lg:px-12 w-full text-center py-20">
        <motion.h1
          className="text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-[1.05] tracking-[-0.02em]"
        ...
        <motion.p
          className="text-white/55 text-xl leading-[1.7] mt-8 max-w-2xl mx-auto font-semibold"
