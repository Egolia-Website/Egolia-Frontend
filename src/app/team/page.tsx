...
const nonExecutiveTeam = [
  ...
  },
  {
    ...
    bio: "Renata Kuberka is an Executive Assistant, Receptionist, and Front Office Coordinator supporting Egolia Group, AvranceCorp Developments, and TradeREA.",
    image: "/images/Board Member/renata-kuberka.png",
    experience: [
      "Front Office — Manages reception services, client and stakeholder communications, and ensures a professional and welcoming experience as the first point of contact for clients, investors, partners, and visitors.",
      "Executive Support — Coordinates executive schedules, meetings, events, webinars, and stakeholder engagement activities, along with handling communications, correspondence, and corporate records.",
      "Operational Coordination — Supports cross-departmental coordination across construction, sales, marketing, investor relations, CRM management, reporting systems, and partnership administration.",
      "Leadership Partnership — Works closely with executive leadership on operational planning, customer service, relationship management, and organizational reporting to ensure projects and initiatives move forward efficiently.",
    ],
  },
  {
    name: "Edmund Hall",
